...
namespace CalculoCDB.Service.Teste.Services
{
    public class BaseServiceTeste
    {
        private readonly IBaseService _baseCdbService;

        public BaseServiceTeste()
        {
        ...
        public void TesteResgatarAplicacao()
        {
            ...
            CertificadoDepositoBancario cdb = _baseCdbService.ResgatarAplicacao<InvestimentoValidator>(investimento);
